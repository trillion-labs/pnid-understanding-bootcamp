...
이 질문은 이미 선택된 P&ID 한 장을 깊게 읽는 작업입니다. 여러 도면 가운데 관련 시트를 고르는 도면 검색 작업과 구분합니다.
...
| [여러 도면에서 관련 시트 찾기](docs/11-real-query-evaluation.md) | 단일 도면 이해와 구분하여 도면 검색 결과를 평가합니다. |
