...
파란 상자는 Feeder #C 단일 도면 이해 질문을 검토하기 위한 구역입니다. 이 안에서 `VIBRO FEEDER #C`, `11520-M-VB-03C`, motor 표기와 Feeder 아래쪽 연결 문맥을 함께 볼 수 있습니다.

빨간 상자는 Flexible Hose와 Boiler OFA의 연결 문맥을 묻는 다른 현업 질문을 검토하기 위한 구역입니다. `FLEXIBLE HOSE`, `RECEPTION BIN 2`, `BOILER OFA`를 함께 확인할 수 있습니다.
