...
<div class="lesson-summary">
  ...
  <ul>
    <li>전체 이미지와 확대 이미지의 역할을 구분합니다.</li>
    <li>질문에 필요한 문맥을 남기면서 확대 범위를 정합니다.</li>
  </ul>
  <p class="lesson-summary__outcome"><strong>완료 기준</strong> 질문에 맞는 이미지 범위와 확대 순서를 선택할 수 있습니다.</p>
</div>
...
그래프에 사용한 정리 데이터와 실험 조건은 `data/image-input-strategy/`에 함께 보관합니다.
