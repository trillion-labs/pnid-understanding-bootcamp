...
> **준비된 PDF 검색은 기본 실습이고, OCR PDF 직접 만들기는 선택 실습입니다.** 선택 실습을 건너뛰어도 다음 단원으로 진행할 수 있습니다.
...
|---|---|
| [원본 도면 열기](/pnid-understanding-bootcamp/downloads/원본-고해상도-도면.png) | [검색 가능한 도면 열기](/pnid-understanding-bootcamp/downloads/검색가능한-pnid.pdf) |
...
검색으로 Reception Bin 2 주변을 찾은 뒤 `V186`과 `11520-M-VB-03C`는 원본 확대 이미지에서 눈으로 확인합니다. OCR이 작은 문자열을 놓치거나 다르게 읽어도 넓은 장비명으로 후보 위치를 좁힌 뒤 원본과 대조하면 이 단원의 목표를 달성한 것입니다.
...
- **이번에 한 일:** 검색 가능한 PDF에서 문자열을 찾고 원본 이미지와 대조했습니다.
- **확인할 결과:** OCR 문자열을 정답이 아니라 확인 위치의 후보로 사용할 수 있습니다.
- **실패해도 괜찮은 항목:** 일부 작은 태그가 검색되지 않아도 됩니다. 직접 PDF를 만드는 선택 실습도 건너뛸 수 있습니다.
- **다음 단계:** 확인한 답이 원본 어디에 있는지 위치 상자로 기록합니다.
