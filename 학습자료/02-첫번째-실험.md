...
>
> 두 번째 실험에서는 이미지 경로만 `실습자료/이미지/feeder-c-확대.png`로 바꾸면 됩니다. 자세한 사용법은 [OpenAI 이미지 입력 안내](https://learn.chatgpt.com/docs/image-inputs)와 [Claude Code CLI 안내](https://docs.anthropic.com/en/docs/claude-code/cli-usage)를 참고하세요.
