...
`텍스트 0줄`은 글자가 페이지 그림의 일부로 저장되어 일반 텍스트 추출기가 읽지 못했다는 뜻입니다. 파일의 실제 내용은 페이지 이미지를 열어 확인합니다.
...
터미널을 사용할 수 있다면 아래 명령을 선택적으로 실행하세요. 핵심은 명령어 암기보다 PDF 상태와 변환 결과를 확인하는 데 있습니다.
