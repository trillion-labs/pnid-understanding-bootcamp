...
P&ID를 건물 평면도처럼 생각하면 오히려 헷갈릴 수 있습니다. 선의 길이는 실제 배관 길이를, 장비 사이의 간격은 실제 설치 거리를 뜻하지 않습니다. P&ID는 어디에 놓였는가보다 <mark class="text-highlight">무엇이 어떻게 연결되었는가</mark>를 보여 주는 도면입니다.
