...
const workbookPages = [
  ...
  ['01-experiment-answer-details.md', '첫 번째 실험의 모델별 상세 답변', '세 모델과 세 입력 조건에서 나온 아홉 개 실제 답변과 검토 의견을 모았습니다.'],
  ...
  ['11-real-query-evaluation.md', '여러 도면에서 관련 P&ID를 찾는 작업', '단일 도면 이해와 구분하여 여러 도면 가운데 관련 시트를 찾는 평가 방법을 설명합니다.'],
